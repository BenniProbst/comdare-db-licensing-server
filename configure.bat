...
if not "%COMDARE_BUILDSYSTEM_PATH%"=="" set "BUILDSYSTEM_DIR=%COMDARE_BUILDSYSTEM_PATH%"
if "%BUILDSYSTEM_DIR%"=="" if defined COMDARE_REPO_ROOT if exist "%COMDARE_REPO_ROOT%\Products\\rc-buildsystem-construct\\Layer1-Foundation\\rc-buildsystem-core\scripts\interface.bat" set "BUILDSYSTEM_DIR=%COMDARE_REPO_ROOT%\Products\\rc-buildsystem-construct\\Layer1-Foundation\\rc-buildsystem-core"
